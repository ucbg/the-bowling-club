                        ...
                        value: (o = i(regeneratorRuntime.mark(function e() {
                            ...
                            return regeneratorRuntime.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return e.prev = 0, t = this.options.debug ? "https://test-hb.improvedigital.com/pbw/gameDistribution.min.js?v=1" : "https://hb.improvedigital.com/pbw/gameDistribution.min.js?v=1", n = (0, p.getScript)(t, "gdsdk_prebid"), window.idhbgd = window.idhbgd || {}, window.idhbgd.que = window.idhbgd.que || [], r = this.options.debug ? "https://imasdk.googleapis.com/js/sdkloader/ima3_debug.js" : "patch/google/ima3.js?imasdk.googleapis.com/js/sdkloader/ima3.js", e.next = 8, (0, p.getScript)(r, "gdsdk_ima");
                                    case 8:
                        ...
                        value: function(o, i) {
                            ...
                            return new Promise(function(n) {
                                var r = {
                                    ...
                                    e = "https://game.api.gamedistribution.com/game/get/".concat(o.replace(/-/g, ""), "/?domain=").concat(i, "&localTime=").concat((new Date).getHours(), "&v=").concat(a.default.version),
                                    t = new Request(e, {
                                        method: "GET"
                                    });
